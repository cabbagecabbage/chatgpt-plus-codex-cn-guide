...
| 模型档位 | 使用场景 | 主要考虑 |
|---|---|---|
| Luna Max | 简单需求，比较在意额度，可以多等一会儿 | 成本低，很多日常任务都能搞定 |
| Sol High | 需求明确、有测试和验收机制的工程开发 | 工程能力强，体感比 Luna Max 完成任务更快 |
| Astra Medium | 方案、机制、架构和 Skill 设计 | 更容易抓住重点，适合依赖判断力和设计质量的任务 |
