...
> 这会导致什么问题？举个例子：
>
> 1. **第一次：** 在手机上，App Store（“媒体与购买项目”）登录 **Apple ID A**，ChatGPT App 登录**账号 1**。你在 ChatGPT App 中点击订阅并完成 Apple 内购付款，账号 1 获得订阅，Apple ID A 与账号 1 绑定。
> 2. **第二次：** 在手机上，App Store 登录 **Apple ID A**，ChatGPT App 登录**账号 2**。你在 ChatGPT App 中再次点击订阅并付款，以为这次是在给账号 2 充值。
