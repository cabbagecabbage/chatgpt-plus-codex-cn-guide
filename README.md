...
> [!CAUTION]
> **首次通过 Apple 内购订阅后，Apple ID 就与当时的 ChatGPT 账号绑定，按目前规则不能换绑，也不能再用它给另一个 ChatGPT 账号订阅。**
>
> 楼主踩过的坑是：**原 ChatGPT 账号已经删除，换号后再次付款，订阅仍关联到了原账号。** 所以第一次付款就要选好准备长期使用的 ChatGPT 账号，别想着以后换绑。
