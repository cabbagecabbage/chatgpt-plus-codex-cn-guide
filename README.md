...
> [!IMPORTANT]
> **想通过 Apple 内购升级 Pro？先开 Plus，再到 Apple 的订阅页面切换方案。** 本文采用这条路径：先订阅 **20 美元/月的 Plus**，再选择 **100 美元/月的 Pro 5×**，或在开放升级时选择 **200 美元/月的 Pro 20×**。
>
> **当前限制（2026 年 9 月 18 日核对）：** OpenAI 自 9 月 10 日起暂停 Pro 20× 的新购和升级，Pro 5× 及已有 Pro 20× 的续订不受影响。**目前不要为了新开 Pro 20× 提前充值。** 详见 [OpenAI 套餐说明](https://help.openai.com/en/articles/9793128)。
>
> 1. 按上面的步骤，在 ChatGPT App 中通过 Apple 内购开通 Plus。
> 2. 打开 **App Store → 右上角头像 → 订阅 → ChatGPT**，确认使用的是刚才付款的美区 ID。
> 3. 点击**查看所有方案（See All Plans）**，选择当前可用的 Pro 方案，核对月费并确认付款。也可以从 **iPhone 设置 → 你的姓名 → 订阅 → ChatGPT → 查看所有方案**进入。操作路径可参考 [Apple 说明](https://support.apple.com/en-us/118448)。
> 4. 返回 ChatGPT App，确认账号已升级为所选 Pro 套餐。
>
> **余额要够付 Pro 的全额，不能只准备差价。** 以 200 美元方案开放时为例：先扣 20 美元开 Plus，切换 Pro 时，Apple 账户里还要有足够支付 200 美元的余额，然后再扣 200 美元。也就是说，若从零开始、全部用余额付款，退款前需要先准备 **220 美元**；100 美元方案同理，需要先准备 **120 美元**。如结算有税费，还需覆盖税费，以确认付款页面的总额为准。
>
> **Plus 的退款在升级后另行退回，不会提前抵扣 Pro 的付款。** 用 Apple 余额购买的 Plus，退款会回到余额中；Apple 按原订阅**未使用的剩余时间**计算退款，刚开通就升级可能退回接近 20 美元，但不是任何时候都全退。社区有次日到账的反馈，也有等待数日的情况，**不能保证 1～2 天到账**。参见 [Apple 升级退款规则](https://developer.apple.com/app-store/subscriptions/)和[社区实际扣款、退款记录](https://linux.do/t/topic/2203753)。
